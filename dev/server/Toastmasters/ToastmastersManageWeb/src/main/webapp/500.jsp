...
<head>
	...
	<title>Toastmasters Web - Internal Server Error</title>
	...
	<!-- Error pages styles -->
	<link rel="stylesheet" media="screen" href="css/error.css?v=1">
...
<body class="clearfix">
	...
	<div id="container">
		...
		<button class="button huge anthracite-gradient glossy full-width" id="button" onclick="window.history.back();">Back</button>
	</div>
